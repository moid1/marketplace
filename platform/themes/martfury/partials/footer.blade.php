 ...
 @if (is_plugin_active('newsletter') && theme_option('enable_newsletter_popup', 'yes') === 'yes')
     ...
     <div class="ps-popup" id="subscribe"
         data-time="{{ (int) theme_option('newsletter_show_after_seconds', 10) * 1000 }}" style="display: none">
     ...
     <div class="ps-search" id="site-search"><a class="ps-btn--close" href="#"></a>
         <div class="ps-search__content">
             <form class="ps-form--primary-search" action="{{ route('public.products') }}"
                 ...
                 <input class="form-control input-search-product" name="q" value="{{ request()->query('q') }}"
                     type="text" autocomplete="off" placeholder="{{ __('Search for...') }}">
